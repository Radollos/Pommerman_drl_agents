...
def make_agent_from_string(agent_string, agent_id, docker_env_dict=None):
    ...
    assert agent_type in ["player", "simple", "random", "docker", "http" , "test", "tensorforce", "myagents"]
    ...
    elif agent_type == "myagents":
        agent_instance = myagents.BaselineAgent(algorithm=agent_control)
